...
static bool add_props_to_default_prop(const mb::device::Device &device)
{
...
static bool symlink_base_dir(const mb::device::Device &device)
{
    struct stat sb;

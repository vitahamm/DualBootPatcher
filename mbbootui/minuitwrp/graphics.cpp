...
static minui_backend* gr_backend = nullptr;
...
void gr_color(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
{
    ...
    if (tw_device.tw_pixel_format() == mb::device::TwPixelFormat::ABGR_8888
            || tw_device.tw_pixel_format() == mb::device::TwPixelFormat::BGRA_8888) {
        color[0] = ((b << 8) | r) + 1;
        color[1] = ((g << 8) | g) + 1;
        color[2] = ((r << 8) | b) + 1;
        color[3] = ((a << 8) | a) + 1;
...
int gr_init(void)
{
    ...
    if (tw_device.tw_flags() & mb::device::TwFlag::TW_SCREEN_BLANK_ON_BOOT) {
